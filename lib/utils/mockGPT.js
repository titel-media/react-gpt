...
exports.CompanionAdsServiceMock = exports.PubAdsServiceMock = exports.SizeMappingBuilderMock = exports.SlotMock = exports.GPTMock = undefined;
                ...
                Object.keys(pubads.listeners).forEach(function (key) {
                    if (pubads.listeners[key]) {
                        pubads.listeners[key].forEach(function (cb) {
                            ...
                            var isEmpty = !!_this6.config.emptyAd;
                            var event = {
                                isEmpty: isEmpty,
                                creativeId: isEmpty ? null : Date.now(),
                                lineItemId: isEmpty ? null : Date.now(),
